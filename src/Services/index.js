...
const Services = () => {
 ...
 <h1 className ="heading">Services</h1>
            ...
            and learn. </p>
            <p><img src = "/images/edu-games.jpg" className = "visuals" alt=''/></p>
            </div>
            ...
            <p><img src = "/images/comm.jpg" className = "visuals-communication" alt=''/></p>
            </div>
            ...
            <p><img src = "/images/noticeboard.webp" className = "visuals-notice" alt=''/></p>
            </div>
